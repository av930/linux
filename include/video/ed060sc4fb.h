...
/* struct used by ed060sc4. board specific stuff comes from *board */
struct ed060sc4fb_par {
	struct fb_info *info;
	struct ed060sc4_board *board;
	void (*send_command)(struct ed060sc4fb_par *, unsigned char);
	void (*send_data)(struct ed060sc4fb_par *, unsigned char);
};
...
struct ed060sc4_board {
	struct module *owner;
	void (*remove)(struct ed060sc4fb_par *);
	void (*set_ctl)(struct ed060sc4fb_par *, unsigned char, unsigned char);
	void (*set_data)(struct ed060sc4fb_par *, unsigned char);
	void (*wait_for_ack)(struct ed060sc4fb_par *, int);
	int (*init)(struct ed060sc4fb_par *);
};
